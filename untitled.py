...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.variable_0 = variable_0 = 2000000
        ...
        self._center_freq_range = qtgui.Range(70e6, 3000e6, 1e6, 100e6, 200)
        self._center_freq_win = qtgui.RangeWidget(self._center_freq_range, self.set_center_freq, "Merkez Frekans", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._center_freq_win)
        self._rx_gain_range = qtgui.Range(0, 70, 1, 50, 200)
